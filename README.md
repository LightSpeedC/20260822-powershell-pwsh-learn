...
📅 作成: 2026-08-22 / 更新: 2026-08-24 ／ 対象: 何らかのプログラミング言語の基礎を知っている方
...
![図 1 — 01 から順に読むのが基本。02・03 は環境が整わないと以降が動かせないため必須](docs/images/readme-fig-01.png)

*図 1 — 01 から順に読むのが基本。02・03 は環境が整わないと以降が動かせないため必須*
...
| ファイル | 内容 |
| --- | --- |
| [docs/plan/構成案.html](docs/plan/構成案.md) | 全体のカリキュラム設計。勉強会の進行案（全5回×90分）もここ |
...
4. Playwright の spec 2本の `targets` に追記する
5. このページの章カードと逆引き索引に追加する

> [!NOTE]
> **Playwright の spec は共有環境側にあります。**
> 
> `N:\2026\PlayWright\projects\20260822-powershell-pwsh-learn\` に `capture-figures.spec.ts` と `export-outline.spec.ts` があります。**対象ファイルの一覧は両方に書く**必要があります。
