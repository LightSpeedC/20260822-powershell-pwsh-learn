...
前章: [08. エラー処理とデバッグ](08-エラー処理.md) ／ 次章: [10. ハンズオン課題](10-ハンズオン.md) ／ [目次に戻る](../README.md)
...
> [!NOTE]
> **`/MIR` はコピー先の余分なファイルを**削除します<strong>。</strong>
> 
...
> 
> スクリプトにパスワードを書くと、**ファイルを読める人全員に漏れます**。タスクスケジューラの GUI で［ユーザーまたはグループの変更］から設定するか、パスワード不要な<strong>サービスアカウント（gMSA）</strong>を使ってください。
> 
